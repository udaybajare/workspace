...
public class InventoryController {
    ...
    protected ModelAndView updateInventory(ChallanDetails challanDetails, String[] inventoryName, String[] material,
	    ...
	    TaxInvoiceDetails taxInvoiceDetails, BillDetails billDetails, AccessoryDetails accessoryDetails, String generateChallan, String generateInvoice) {
	...
	for (int i = 0; i < inventorySpec.size(); i++) {
	    ...
	    if (billDetails.getBillNumber() != null && billDetails.getBillNumber() != "") {
